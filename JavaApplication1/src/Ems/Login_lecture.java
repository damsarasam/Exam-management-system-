 ...
 * @author damsara
 */
public class Login_lecture extends javax.swing.JFrame {

    /**
     * Creates new form Logging_in
     */
    public Login_lecture() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Login_lecture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Login_lecture().setVisible(true);
            }
        });
    }
